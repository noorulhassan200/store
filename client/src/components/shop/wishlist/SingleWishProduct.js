...
import { useNavigate } from "react-router-dom"; // Use `useNavigate` instead of `useNavigate`
import { wishListProducts } from "./FetchApi";
import { formatPrice } from "../partials/Mixins";
const apiURL = process.env.REACT_APP_API_URL;

const Product = () => {
  const navigate = useNavigate(); // Replace useNavigate with useNavigate
            ...
            return (
              ...
              >
                <div className="md:w-1/2 md:flex md:items-center">
                  <img
                    onClick={(e) => navigate(`/products/${product._id}`)} // Replace navigate with navigate
