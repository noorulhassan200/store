    ...
    <Fragment>
      <tr>
        ...
        <td className="p-2 flex items-center justify-center">
          ...
          >
            <svg className="w-6 h-6 fill-current text-green-500" fill="currentColor" viewBox="0 0 20 20">
          ...
          <span
            ...
            className="cursor-pointer hover:bg-gray-200 rounded-lg p-2 mx-1"
          >
            <svg className="w-6 h-6 fill-current text-red-500" fill="currentColor" viewBox="0 0 20 20">
